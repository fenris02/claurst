...
use crate::overlays::{CLAURST_PANEL_BG, centered_rect, modal_search_line};
...
pub fn format_model_line(
    model_str: &str, context_window: Option<u32>, cost_per_1m: Option<f64>,
) -> String {
...
pub fn models_for_provider_from_registry(
    provider_id: &str, registry: &claurst_api::ModelRegistry,
) -> Vec<ModelEntry> {
...
impl ModelPickerState {
    ...
    pub fn open_with_title(
        &mut self, title: impl Into<String>, current_model: &str, effort: EffortLevel,
        fast_mode: bool,
    ) {
...
pub fn render_model_picker(state: &ModelPickerState, area: Rect, buf: &mut Buffer) {
    ...
    use ratatui::{prelude::Stylize, widgets::Widget};
