...
use crate::overlays::{
    CLAURST_ACCENT, CLAURST_MUTED, CLAURST_PANEL_BG, CLAURST_TEXT, begin_modal_buf,
...
pub fn build_turn_diff(
    file_history: &FileHistory, turn_index: usize, project_root: &std::path::Path,
) -> Vec<FileDiffStats> {
    file_history
...
pub fn build_latest_turn_diff(
    file_history: &FileHistory, project_root: &std::path::Path,
) -> Vec<FileDiffStats> {
