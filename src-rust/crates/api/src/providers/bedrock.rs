...
use claurst_core::{
    ...
    types::{ContentBlock, MessageContent, Role, ToolResultContent, UsageInfo},
};
use futures::Stream;
use serde_json::{Value, json};
use tracing::debug;

use super::{message_normalization::remove_empty_messages, request_options::merge_bedrock_options};
use crate::{
...
impl BedrockProvider {
    ...
    fn sign_request(
        &self, method: &str, url_str: &str, body: &str, date: &chrono::DateTime<chrono::Utc>,
...
fn parse_bedrock_event(
    val: &Value, provider_id: &ProviderId, message_started: &mut bool,
